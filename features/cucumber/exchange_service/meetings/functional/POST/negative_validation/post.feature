...
Feature: Create Meeting
  ...
  "optionalAttendees": [
    ...
    Examples:
      ...
      | "Test"  | "Scrum of Room Manager" | "2017-10-40T19:00:00.00Z"  | "2017-10-25T17:00:00.00Z" | "Arani"  | "Administrator@arabitpro.local" | "stacy.hirano@server.lab" | 400  | "SchemaValidationError" | "Start shouldn't be greater than End."                    |
      ...
      | "Test"  | "Scrum of Room Manager" | "2017-10-25T16:00:00.00Z"  | "2017-18-25T17:00:00.00Z" | "Arani"  | "Administrator@arabitpro.local" | "stacy.hirano@server.lab" | 400  | "SchemaValidationError" | "data.end should match format \"date-time\""              |
