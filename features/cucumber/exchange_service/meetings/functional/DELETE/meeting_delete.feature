...
Feature: Delete Meeting Exchange Service
  ...
  Scenario Outline: Delete Meeting
    ...
    Examples:
      ...
      | 345345345423423 | application/json | QWRtaW5pc3RyYXRvcjpBQkMxMjN9 | 400  | "InvalidIdFormatError"      | "The meetingId '345345345423423' argument passed in must be a String of 12 bytes or a string of 24 hex characters." |
